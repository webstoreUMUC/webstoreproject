...
<body>
  ...
  <div class="container" style="margin-top: 75px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Kids Clothes</h1>
        <div class="list-group">
          <a href="kids_pants_1.php" class="list-group-item">Pants</a>
          <a href="kids_shirts_1.php" class="list-group-item">Shirts</a>
          <a href="kids_shoes_1.php" class="list-group-item">Shoes</a>
            <a href="kids_jackets_1.php" class="list-group-item">Jackets</a>
            <a href="kids_longsleeves_1.php" class="list-group-item">Long Sleeves</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/kids_slide_3.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/kids_slide_1.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/kids_slide_2.jpg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="kids_pants_1.php"><img class="card-img-top" src="assets/img/backgrounds/kids_pants.jpg" alt="kids pants"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="kids_pants_1.php">Pants</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="kids_shirts_1.php"><img class="card-img-top" src="assets/img/backgrounds/kids_shirt.jpeg" alt="kids shirt"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="kids_shirts_1.php">Shirts</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="kids_shoes_1.php"><img class="card-img-top" src="assets/img/backgrounds/kids_shoes.jpeg" alt="kids shoes"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="kids_shoes_1.php">Shoes</a>
                </h4>
          ...
          <div id="jacket" class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="kids_jackets_1.php"><img class="card-img-top" src="assets/img/backgrounds/kids_jacket.jpeg" alt="kids Jacket"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="kids_jackets_1.php">Jackets</a>
                </h4>
          ...
          <div id="long_sleeve" class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="kids_longsleeves_1.php"><img class="card-img-top" src="assets/img/backgrounds/kids_long_sleeve.jpeg" alt="Kid long sleeves"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="kids_longsleeves_1.php">Long Sleeves</a>
                </h4>
