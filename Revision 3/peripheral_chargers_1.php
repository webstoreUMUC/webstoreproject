...
$sql = "SELECT productName, productCategory, productQty, price FROM $table where productID = $ID";
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <img class="card-img-top img-fluid" src="assets/img/backgrounds/peripherals_phone_charger.jpeg" alt="">
                    <div class="card-body">
