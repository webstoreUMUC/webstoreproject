    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item">iPhone 11</a>
          <a href="#" class="list-group-item">Galaxy S10</a>
          <a href="#" class="list-group-item">Google Pixel 3</a>
            <a href="#" class="list-group-item">Razer</a>
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/phones_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/phones_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/phone_slide_3.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="phones_iphone_1.php"><img class="card-img-top" src="assets/img/backgrounds/phones_iphone.jpeg" alt="iPhone"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="phones_iphone_1.php">iPhone 11</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="phones_galaxy_1.php"><img class="card-img-top" src="assets/img/backgrounds/phones_galaxy.jpeg" alt="galaxy S10"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="phones_galaxy_1.php">Galaxy S10</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="phones_googlepixel3_1.php"><img class="card-img-top" src="assets/img/backgrounds/phone_google.jpeg" alt="google pixel 3"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="phones_googlepixel3_1.php">Google Pixel 3</a>
                </h4>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="phones_razer_1.php"><img class="card-img-top" src="assets/img/backgrounds/phone_razer.jpeg" alt="razer"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="phones_razer_1.php">Razer</a>
                </h4>
