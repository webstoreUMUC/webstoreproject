      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/consoles_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/consoles_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/consoles_slide_3.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row" style="margin-bottom: 50px;">
            ...
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/backgrounds/consoles_xbox.jpeg" alt="xbox"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="consoles_xbox_1.php">XBox</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/backgrounds/consoles_ps4.jpeg" alt="PS4"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">PS4</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/backgrounds/consoles_switch.jpeg" alt="switch"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="mens_shoe_1.php">Switch</a>
                </h4>
