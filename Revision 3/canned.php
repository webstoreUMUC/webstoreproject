...
<body>
  ...
  <div class="container" style="margin-top: 80px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Canned Goods</h1>
        <div class="list-group">
            <a href="canned_soup_1.php" class="list-group-item">Soup</a>
          <a href="canned_fruit_1.php" class="list-group-item">Fruit</a>
          <a href="canned_vegetable_1.php" class="list-group-item">Vegetables</a>
            <a href="canned_fish_1.php" class="list-group-item">Fish</a>
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/food_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/food_slide_3.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/food_slide_1.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="canned_soup_1.php"><img class="card-img-top" src="assets/img/backgrounds/soup_image.jpg" alt="kids pants"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="canned_soup_1.php">Soup</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="canned_fruit_1.php"><img class="card-img-top" src="assets/img/backgrounds/canned_fruit_image.jpeg" alt="kids shirt"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="canned_fruit_1.php">Fruit</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="canned_vegetable_1.php"><img class="card-img-top" src="assets/img/backgrounds/canned_image.jpeg" alt="kids shoes"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="canned_vegetable_1.php">Vegetables</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="canned_fish_1.php"><img class="card-img-top" src="assets/img/backgrounds/canned_fish_image.jpg" alt="kids shoes"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="canned_fish_1.php">Fish</a>
                </h4>
