...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="laptops.php">Peripherals</a>
                            <a class="dropdown-item" href="accessories.php">Consoles</a>
                        </div>
                    </li>
  ...
  <div class="container" style="margin-top: 80px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Natural Juices</h1>
        <div class="list-group">
            <a href="natural_applejuice_1.php" class="list-group-item">Apple Juice</a>
          <a href="natural_cranberryjuice_1.php" class="list-group-item">Cranberry Juice</a>
          <a href="natural_orangejuice_1.php" class="list-group-item">Orange Juice</a>
      ...
      <div class="col-lg-9" style="margin-bottom: 50px;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/natural_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/natural_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/natural_slide_3.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="natural_applejuice_1.php"><img class="card-img-top" src="assets/img/backgrounds/natural_apple.jpeg" alt="apple"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="natural_applejuice_1.php">Apple juice</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="natural_cranberryjuice_1.php"><img class="card-img-top" src="assets/img/backgrounds/natural_cranberry.jpeg" alt="cranberry"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="natural_cranberryjuice_1.php">Cranberry Juice</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="natural_orangejuice_1.php"><img class="card-img-top" src="assets/img/backgrounds/natural_orange.jpeg" alt="orange"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="natural_orangejuice_1.php">Orange Juice</a>
                </h4>
