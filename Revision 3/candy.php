...
$sql5 = "SELECT price FROM food where productID = $product5";
...
<body>
  ...
  <div class="container" style="margin-top: 80px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Candy</h1>
        <div class="list-group">
            <a href="candy_skittles_1.php" class="list-group-item">Skittles</a>
          <a href="candy_snickers_1.php" class="list-group-item">Snickers</a>
          <a href="candy_mm_1.php" class="list-group-item">M &amp; M's</a>
            <a href="candy_starburst_1.php" class="list-group-item">Starburst</a>
            <a href="candy_gum_1.php" class="list-group-item">Trident Gum</a>
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/candy_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/candy_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/candy_slide_3.jpg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="candy_skittles_1.php"><img class="card-img-top" src="assets/img/backgrounds/candy_skittles.jpeg" alt="candy_skittles"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="candy_skittles_1.php">Skittles</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="candy_snickers_1.php"><img class="card-img-top" src="assets/img/backgrounds/candy_snickers.jpeg" alt="snickers"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="candy_snickers_1.php">Snickers</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="candy_mm_1.php"><img class="card-img-top" src="assets/img/backgrounds/candy_mm.jpeg" alt="MM"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="candy_mm_1.php">M &amp; M's</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="candy_starburst_1.php"><img class="card-img-top" src="assets/img/backgrounds/candy_starburst.jpeg" alt="starburst"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="candy_starburst_1.php">Starburst</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="candy_gum_1.php"><img class="card-img-top" src="assets/img/backgrounds/candy_gum.jpeg" alt="gum"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="candy_gum_1.php">Trident Gum</a>
                </h4>
                <h5>$<?php echo $price4;?></h5>
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
              </div>
