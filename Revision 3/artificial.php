...
<head>
  ...
  <title>Artificial Beverages</title>
...
<body>
  ...
  <div class="container" style="margin-top: 80px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Artificial Juices</h1>
        <div class="list-group">
            <a href="artificial_fruitpunch_1.php" class="list-group-item">Fruit Punch</a>
          <a href="artificial_blueberry_1.php" class="list-group-item">Blueberry</a>
          <a href="artificial_cherry_1.php" class="list-group-item">Cherry</a>
      ...
      <div class="col-lg-9" style="margin-bottom: 50px;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/artificial_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/artificial_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/artificial_slide_3.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="artificial_fruitpunch_1.php"><img class="card-img-top" src="assets/img/backgrounds/artificial_fruitpunch.jpeg" alt="fruitpunch"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="artificial_fruitpunch_1.php">Fruit Punch</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="artificial_blueberry_1.php"><img class="card-img-top" src="assets/img/backgrounds/artificial_blueberry.jpeg" alt="blueberry"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="artificial_blueberry_1.php">Blueberry</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="artificial_cherry_1.php"><img class="card-img-top" src="assets/img/backgrounds/artificial_cherry.jpeg" alt="cherry"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="artificial_cherry_1.php">Cherry</a>
                </h4>
