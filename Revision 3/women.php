...
<body>
  ...
  <div class="container" style="margin-top: 75px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Women's Clothes</h1>
        <div class="list-group">
          <a href="womens_pants_1.php" class="list-group-item">Pants</a>
          <a href="womens_shirts_1.php" class="list-group-item">Shirts</a>
          <a href="womens_shoe_1.php" class="list-group-item">Shoes</a>
            <a href="womens_dress_1.php" class="list-group-item">Dresses</a>
            <a href="womens_skirts_1.php" class="list-group-item">Skirts</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/womens_shoe.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/womens_blouse.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/womens_coat.jpg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="womens_pants_1.php"><img class="card-img-top" src="assets/img/backgrounds/womens_pants.jpeg" alt="womens pants"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="womens_pants_1.php">Pants</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="womens_shirts_1.php"><img class="card-img-top" src="assets/img/backgrounds/womens_shirt.jpg" alt="womens shirt"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="womens_shirts_1.php">Shirts</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="womens_shoe_1.php"><img class="card-img-top" src="assets/img/backgrounds/womens_heels.jpg" alt="womens heels"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="womens_shoe_1.php">Shoes</a>
                </h4>
          ...
          <div id="dress" class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="womens_dress_1.php"><img class="card-img-top" src="assets/img/backgrounds/womens_dress.jpg" alt="womens dress"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="womens_dress_1.php">Dresses</a>
                </h4>
          ...
          <div id="skirt" class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="womens_skirts_1.php"><img class="card-img-top" src="assets/img/backgrounds/womens_skirt.jpg" alt="womens skirts"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="womens_skirts_1.php">Skirts</a>
                </h4>
