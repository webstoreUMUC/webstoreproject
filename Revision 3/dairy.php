...
<body>
  ...
  <div class="container" style="margin-top: 80px;">
    <div class="row">
      <div class="col-lg-3">
        <h1 class="my-4">Dairy</h1>
        <div class="list-group">
            <a href="dairy_milk_1.php" class="list-group-item">Milk</a>
          <a href="dairy_chocolatemilk_1.php" class="list-group-item">Chocolate Milk</a>
          <a href="dairy_almondmilk_1.php" class="list-group-item">Almond Milk</a>
      ...
      <div class="col-lg-9" style="margin-bottom: 50px;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="assets/img/backgrounds/dairy_slide_1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/dairy_slide_2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="assets/img/backgrounds/dairy_slide_3.jpeg" alt="Third slide">
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card h-100">
              <a href="dairy_milk_1.php"><img class="card-img-top" src="assets/img/backgrounds/dairy_milk.jpeg" alt="milk"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="dairy_milk_1.php">Milk</a>
                </h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="dairy_chocolatemilk_1.php"><img class="card-img-top" src="assets/img/backgrounds/dairy_chocolate_milk.jpeg" alt="chocolatemilk"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="dairy_chocolatemilk_1.php">Chocolate Milk</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="dairy_almondmilk_1.php"><img class="card-img-top" src="assets/img/backgrounds/dairy_almond_milk.jpeg" alt="almondmilk"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="dairy_almondmilk_1.php">Almond Milk</a>
                </h4>
